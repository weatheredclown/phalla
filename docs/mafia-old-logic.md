...
| `posts.inc` | Generates the main thread view: alternating post chrome, avatars, action callouts (votes/claims), and edit/delete links. | ✅ | `legacy/game.js` rebuilds post rendering from Firestore with inline action badges tied to recorded actions plus edit/delete/quote controls that mirror the legacy callouts. 【F:madia.new/public/legacy/game.js†L204-L315】【F:madia.new/public/legacy/game.js†L319-L360】【F:madia.new/public/legacy/game.js†L560-L600】|

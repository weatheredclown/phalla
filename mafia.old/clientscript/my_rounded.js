...
function Rounded(className, sizex, sizey, sizex_b, sizey_b, leftside, rightside) {
	var bk;
	...
	for (var i = 0; i < l; i++) {
		...
		AddRounded(v[i], bk, color, sizex, sizey, true, leftside, rightside);
		AddRounded(v[i], bk, color, sizex_b, sizey_b, false, leftside, rightside);
	}
}
...
function AddRounded(el, bk, color, sizex, sizey, top, leftside, rightside) {
  if (!sizex && !sizey)
	return;
  var i, j;

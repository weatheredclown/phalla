...
Public Function SHA256(sMessage, maxlen)
    Dim HASH(7)
    Dim M
    Dim W(63)
    Dim a
    ...
    result = LCase(Right("00000000" & Hex(HASH(0)), 8) & Right("00000000" & Hex(HASH(1)), 8) & Right("00000000" & Hex(HASH(2)), 8) & Right("00000000" & Hex(HASH(3)), 8) & Right("00000000" & Hex(HASH(4)), 8) & Right("00000000" & Hex(HASH(5)), 8) & Right("00000000" & Hex(HASH(6)), 8) & Right("00000000" & Hex(HASH(7)), 8))
    if len(result) > maxlen then result = left(result, maxlen)
    SHA256 = result
End Function
%>
